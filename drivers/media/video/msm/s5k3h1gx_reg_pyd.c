...
struct s5k3h1gx_i2c_reg_conf s5k3h1gx_fast_video_settings_array_mipi[] =
{
	{0x0305, 0x06}, /*pre_pll_clk_div = 4*/
	{0x0306, 0x00}, /*pll_multiplier*/
	{0x0307, 0xb9}, /*pll_multiplier	= 125*/
	{0x0303, 0x01}, /*vt_sys_clk_div = 1*/
	{0x0301, 0x05}, /*vt_pix_clk_div = 5*/
	{0x030B, 0x01}, /*op_sys_clk_div = 1*/
	{0x0309, 0x05}, /*op_pix_clk_div = 5*/
	{0x30CC, 0xb0}, /*DPHY_band_ctrl Mbps*/

	{0x0344, 0x01}, /*X addr start*/
	{0x0345, 0x58},
	{0x0346, 0x01}, /*Y addr start*/
	{0x0347, 0xF0},
	{0x0348, 0x0B}, /*X addr end*/
	{0x0349, 0x77},
	{0x034A, 0x07}, /*Y addr end*/
	...
	{0x0342, 0x0D}, /*Line_length_pck 3470d*/
	{0x0343, 0x8E},
	{0x0340, 0x02}, /*Frame_length_lines 1440d*/
	{0x0341, 0xF0}, /*5E=49FPS*/
...
struct s5k3h1gx_reg_t s5k3h1gx_regs = {
	...
	.fast_video_mipi = &s5k3h1gx_fast_video_settings_array_mipi[0],
	.fast_video_mipi_size = ARRAY_SIZE(s5k3h1gx_fast_video_settings_array_mipi),
